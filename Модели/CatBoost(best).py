...
df_train = pd.read_csv('обучение/train_AIC_processed_v19.csv', index_col=0)
df_test = pd.read_csv('обучение/test_AIC_processed_v19.csv', index_col=0)
...
pickle.dump(ct_model, open("catboost_model.pkl", "wb"))
